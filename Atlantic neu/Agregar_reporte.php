...
<head>
    ...
    .form-section {
        background-color: #ffffff; /* Color de fondo de las secciones del formulario */
        padding: 20px;
        margin-top: 20px;
        border-radius: 10px;
...
<body>
    ...
    <?php endforeach; ?>
                ...
                <button type="button" class="btn btn-danger delete-record" data-id="<?php echo $impresion['id']; ?>">
...
function deleteRecord(id) {
    axios.post('./eliminar_registro.php', { id: id })
